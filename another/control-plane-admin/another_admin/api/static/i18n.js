...
const STRINGS = {
  ru: {
    ...
    pollNote: "Поллинг каждые 10 с. По умолчанию показывается хеш IP; сырой IP — только в режиме расследования.",
    colNode: "узел",
  ...
  en: {
    ...
    pollNote: "Polls every 10s. IP hash by default; raw IP only in investigation mode.",
    colNode: "node",
    colEntrypoint: "entrypoint",
    colIp: "ip",
