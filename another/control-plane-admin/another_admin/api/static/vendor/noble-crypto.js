/**
 * Vendored crypto for the another admin panel. No CDN is contacted at runtime.
 *
 * Bundled with esbuild (ESM, unminified so the code stays auditable):
 *   @noble/hashes 1.8.0        -> sha3_256
 *   @noble/post-quantum 0.4.1  -> ml_dsa65
 *
 * Both packages are MIT licensed, Copyright (c) 2024 Paul Miller (https://paulmillr.com).
 * Full license text: ./LICENSE  |  Regeneration steps: ./README.md
 *
