...
def get_prompt():
    """Compiles the prompt, safely exchanging placeholders for current names."""
...
def trim_history():
    """Ensures the chat history fits inside the context window."""
    global chat_history
    ...
    # Drop from the oldest entries in the array to free space
