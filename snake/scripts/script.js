document.addEventListener('DOMContentLoaded', function() {
    ...
    async function setRandomVideo() {
        ...
        const videoPath = `https://cdn.jsdelivr.net/gh/Nergan/cdn@main/mainpage-backgrounds/${selectedVideo}`;
        ...
        videoBg.onerror = () => {
            ...
            const fallbackPath = `https://cdn.jsdelivr.net/gh/Nergan/cdn@main/mainpage-backgrounds/${videoList[fallbackIndex]}`;
            videoBg.innerHTML = '';
